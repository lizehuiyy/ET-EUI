...
namespace ET
{
	...
	public static  class DlgRedDotSystem
	{
		...
		{
            self.View.EButton_BagNode1Button.onClick.AddListener(() => { self.OnBagNode1ClickHandler(); });
            self.View.EButton_BagNode2Button.onClick.AddListener(() => { self.OnBagNode2ClickHandler(); });
            self.View.EButton_MailNode1Button.onClick.AddListener(() => { self.OnMailNode1ClickHandler(); });
            self.View.EButton_MailNode2Button.onClick.AddListener(() => { self.OnMailNode2ClickHandler(); });
		...
		public static void ShowWindow(this DlgRedDot self, Entity contextData = null)
		{
            ...
            RedDotHelper.RefreshRedDotViewCount(self.ZoneScene(), self.View.EButton_MailNode2Button.name, self.RedDotMailCount1);
